  ...
  return (
    <Layout title={"About Me - "}>
      <div className="flex flex-col-reverse lg:flex-row w-full justify-between items-center">
        <div className="w-full lg:pr-36 text-justify">
          <h1 className="lg:text-4xl underline  text-center rounded-lg text-white text-3xl font-extrabold dark:bg-clip-text dark:text-transparent bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100">
          ...
          <div className="flex gap-6 mt-4 items-center justify-between lg:justify-center">
            <Tooltip content="NextJS" color="invert" placement="bottom">
              <svg
                className=" fill-slate-50  hover:-translate-y-2 duration-700 h-10"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <Tooltip content="TailwindCSS" color="invert" placement="bottom">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_2198_3297)">
            ...
            <Tooltip content="Flutter" color="invert" placement="bottom">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_2198_3298)">
            ...
            <Tooltip content="Firebase" color="invert" placement="bottom">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_2198_3301)">
