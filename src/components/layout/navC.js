...
export default function NavC() {
  ...
  return (
    <div>
      ...
      <div className="bg-white text-sm lg:text-base px-10 lg:px-36 dark:bg-slate-900 flex justify-between items-center py-7 place-items-center fixed w-full z-[9999]">
              ...
              <Link
                ...
                className={
                  route.pathname != e.href
                    ? `border-b-[2px] hover:border-[#F1CCD6] duration-1000 border-transparent transition-all`
                    : `border-b-[2px] border-[#F1CCD6] duration-1000 transition-all`
                }
                href={e.href}
              >
                {e.title}
        ...
        <div title="Dark Mode" className="border p-1 rounded-lg ">
          <svg
            onClick={() => {
              if (theme == "dark") {
                setTheme("light");
            ...
            className="dark:fill-white fill-black  hover:animate-spin hover:cursor-pointer"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle opacity="0.4" cx="12" cy="12" r="6" />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M19.6015 19.6016C19.3086 19.8945 18.8337 19.8945 18.5408 19.6016L17.8337 18.8945C17.5408 18.6016 17.5408 18.1267 17.8337 17.8339C18.1266 17.541 18.6015 17.541 18.8944 17.8339L19.6015 18.541C19.8944 18.8339 19.8944 19.3087 19.6015 19.6016Z"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M6.16645 6.16656C5.87355 6.45945 5.39868 6.45945 5.10579 6.16656L4.39868 5.45945C4.10579 5.16656 4.10579 4.69169 4.39868 4.39879C4.69157 4.1059 5.16645 4.1059 5.45934 4.39879L6.16645 5.1059C6.45934 5.39879 6.45934 5.87367 6.16645 6.16656Z"
            />
          </svg>
        </div>
        {/* 
